            ...
            <div class="col s12">
                ...
                <div class="modal" id="modal-product-form">
                    <div class="modal-content">
                        <h4 id="modal-product-title">Create a new product</h4>
                        <div class="row">
    ...
    <script>
        ...
        app.controller('productsCtrl', function($scope, $http) {
                ...
                $scope.showCreateForm = function() {
                        ...
                        //change modal title
                        $('#modal-product-title').text("Create a new Product");
                ...
                $scope.createProduct = function() {
                    ...
                    $http.post('create_product.php', {
                        ...
                        //tell the user new product was create_product
                        Materialize.toast(data, 4000);

                        //close modal
                        $('#moda-product-form').closeModal();
